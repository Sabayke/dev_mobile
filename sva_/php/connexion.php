        ...
        <div class="mx-auto col-md-6 col-10 bg-white p-5">
          ...
          <form method="POST" action="controlc.php">
            ...
            <div class="form-group mb-3">
              <input type="text" class="form-control" placeholder="Entrez votre login" id="login" name="login" id="login" required onblur="verifchamp(this)"><span id="veriflog"></span>
            </div>

            <div class="form-group mb-3">
              <input type="password" name="pass" id="pass" class="form-control" placeholder="Entez votre Mot de passe" id="form10" required onblur="verifchamp(this)"><span id="verifpasss"></span>
            </div>
